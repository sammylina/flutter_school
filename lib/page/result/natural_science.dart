...
class NaturalScience extends StatefulWidget {
  const NaturalScience({Key? key}) : super(key: key);

  @override
  State<NaturalScience> createState() => _NaturalScienceState();
}

class _NaturalScienceState extends State<NaturalScience> {
  @override
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            TextFormField(
              onSaved: (value) {
                formData['Drawing'] = value;
              },
              decoration: const InputDecoration(
                icon: const Icon(Icons.school),
                hintText: 'Technical Drawing Result',
              ),
              keyboardType: TextInputType.number,
            ),
            TextFormField(
